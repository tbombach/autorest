...
public final class StorageAccountsImpl implements StorageAccounts {
     ...
     */
    public CheckNameAvailabilityResult checkNameAvailability(StorageAccountCheckNameAvailabilityParameters accountName) throws CloudException, IOException, IllegalArgumentException {
     ...
     */
    public StorageAccount create(String resourceGroupName, String accountName, StorageAccountCreateParameters parameters) throws CloudException, IOException, IllegalArgumentException, InterruptedException {
     ...
     * @return the StorageAccount object if successful.
     */
    public StorageAccount beginCreate(String resourceGroupName, String accountName, StorageAccountCreateParameters parameters) throws CloudException, IOException, IllegalArgumentException {
     ...
     * @return the StorageAccount object if successful.
     */
    public StorageAccount getProperties(String resourceGroupName, String accountName) throws CloudException, IOException, IllegalArgumentException {
     ...
     * @return the StorageAccount object if successful.
     */
    public StorageAccount update(String resourceGroupName, String accountName, StorageAccountUpdateParameters parameters) throws CloudException, IOException, IllegalArgumentException {
     ...
     */
    public StorageAccountKeys listKeys(String resourceGroupName, String accountName) throws CloudException, IOException, IllegalArgumentException {
     ...
     */
    public List<StorageAccount> list() throws CloudException, IOException, IllegalArgumentException {
     ...
     * @return the List&lt;StorageAccount&gt; object if successful.
     */
    public List<StorageAccount> listByResourceGroup(String resourceGroupName) throws CloudException, IOException, IllegalArgumentException {
     ...
     * @return the StorageAccountKeys object if successful.
     */
    public StorageAccountKeys regenerateKey(String resourceGroupName, String accountName, StorageAccountRegenerateKeyParameters regenerateKey) throws CloudException, IOException, IllegalArgumentException {
