...
public interface StorageAccounts {
     ...
     */
    CheckNameAvailabilityResult checkNameAvailability(StorageAccountCheckNameAvailabilityParameters accountName) throws CloudException, IOException, IllegalArgumentException;
     ...
     */
    StorageAccount create(String resourceGroupName, String accountName, StorageAccountCreateParameters parameters) throws CloudException, IOException, IllegalArgumentException, InterruptedException;
     ...
     * @return the StorageAccount object if successful.
     */
    StorageAccount beginCreate(String resourceGroupName, String accountName, StorageAccountCreateParameters parameters) throws CloudException, IOException, IllegalArgumentException;
     ...
     * @throws IllegalArgumentException exception thrown from invalid parameters
     */
    void delete(String resourceGroupName, String accountName) throws CloudException, IOException, IllegalArgumentException;
     ...
     * @return the StorageAccount object if successful.
     */
    StorageAccount getProperties(String resourceGroupName, String accountName) throws CloudException, IOException, IllegalArgumentException;
     ...
     * @return the StorageAccount object if successful.
     */
    StorageAccount update(String resourceGroupName, String accountName, StorageAccountUpdateParameters parameters) throws CloudException, IOException, IllegalArgumentException;
     ...
     */
    StorageAccountKeys listKeys(String resourceGroupName, String accountName) throws CloudException, IOException, IllegalArgumentException;
     ...
     */
    List<StorageAccount> list() throws CloudException, IOException, IllegalArgumentException;
     ...
     * @return the List&lt;StorageAccount&gt; object if successful.
     */
    List<StorageAccount> listByResourceGroup(String resourceGroupName) throws CloudException, IOException, IllegalArgumentException;
     ...
     * @return the StorageAccountKeys object if successful.
     */
    StorageAccountKeys regenerateKey(String resourceGroupName, String accountName, StorageAccountRegenerateKeyParameters regenerateKey) throws CloudException, IOException, IllegalArgumentException;
