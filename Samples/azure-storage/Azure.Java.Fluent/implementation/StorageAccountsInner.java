...
public final class StorageAccountsInner {
     ...
     */
    public CheckNameAvailabilityResultInner checkNameAvailability(StorageAccountCheckNameAvailabilityParametersInner accountName) throws CloudException, IOException, IllegalArgumentException {
     ...
     */
    public StorageAccountKeysInner listKeys(String resourceGroupName, String accountName) throws CloudException, IOException, IllegalArgumentException {
     ...
     * @return the StorageAccountKeysInner object if successful.
     */
    public StorageAccountKeysInner regenerateKey(String resourceGroupName, String accountName, StorageAccountRegenerateKeyParametersInner regenerateKey) throws CloudException, IOException, IllegalArgumentException {
