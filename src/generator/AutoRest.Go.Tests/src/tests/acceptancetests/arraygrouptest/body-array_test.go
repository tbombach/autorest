...
/// For null, change to false (default value)
...
// date and time - need to change UnmarshallJSON for lower t and z
...
// wrong duration in swagger P5DT1H0M0S
...
// Returns error because parameter is required parameter
// and can't null or empty.
...
//Not passing because of conversion -- CHECK
