 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Paging.prototype.getMultiplePagesFragmentNextLinkNext = function (apiVersion, tenant, page, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  try {
    ...
    if (page === null || page === undefined || typeof page.valueOf() !== 'string') {
      throw new Error('page cannot be null or undefined and it must be of type string.');
    }
    if (this.client.acceptLanguage !== null && this.client.acceptLanguage !== undefined && typeof this.client.acceptLanguage.valueOf() !== 'string') {
      throw new Error('this.client.acceptLanguage must be of type string.');
    }
  ...
  var queryParameters = [];
  queryParameters.push('api-version=' + encodeURIComponent(apiVersion));
  queryParameters.push('page=' + encodeURIComponent(page));
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
  }
  // trim all duplicate forward slashes in the url
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Paging.prototype.getMultiplePagesFragmentNextLinkNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Paging.prototype.getMultiplePagesFragmentNextLinkNextNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
